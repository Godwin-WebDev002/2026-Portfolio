    ...
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="z-2">
          ...
          <h1 className="text-6xl md:text-9xl font-black tracking-tighter mb-6 bg-gradient-to-b from-white to-purple-700/40 bg-clip-text text-transparent">
            FRONT-END
            <br />
            DEVELOPER
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ProjectCard
              ...
              liveUrl="osesrealest.netlify.app/"
              image="RealestP.png"
            />
            <ProjectCard
